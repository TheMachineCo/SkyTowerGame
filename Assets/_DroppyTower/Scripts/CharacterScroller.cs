    ...
    public class CharacterScroller : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            for (int i = 0; i < CharacterManager.Instance.characters.Length; i++)
            {
                ...
                if (character.GetComponent<CubeController>() != null)
                {
                    Component cubeController = character.GetComponent<CubeController>();
                    DestroyImmediate(cubeController);
                }
                Component component=character.GetComponent<Rigidbody>();
                if(component!=null)
        ...
        public void SelectCharacter()
        {
            ...
            PlayerController.height=(currentCharacter.GetComponent<MeshFilter>().mesh.bounds.extents.y) * currentCharacter.transform.lossyScale.y * 2.0f;
        }
    }
}